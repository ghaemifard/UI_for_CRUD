...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Up Aspect</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.aut.islab.ghaemi.minuy.myUiDsl.impl.UpAspectImpl#getValue <em>Value</em>}</li>
 *   <li>{@link edu.aut.islab.ghaemi.minuy.myUiDsl.impl.UpAspectImpl#getMeasureType <em>Measure Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpAspectImpl extends MinimalEObjectImpl.Container implements UpAspect
{
  /**
  ...
  {
    return MyUiDslPackage.Literals.UP_ASPECT;
  }
  ...
  public void setValue(int newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyUiDslPackage.UP_ASPECT__VALUE, oldValue, value));
  }
  ...
  public void setMeasureType(String newMeasureType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyUiDslPackage.UP_ASPECT__MEASURE_TYPE, oldMeasureType, measureType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyUiDslPackage.UP_ASPECT__VALUE:
        return getValue();
      case MyUiDslPackage.UP_ASPECT__MEASURE_TYPE:
