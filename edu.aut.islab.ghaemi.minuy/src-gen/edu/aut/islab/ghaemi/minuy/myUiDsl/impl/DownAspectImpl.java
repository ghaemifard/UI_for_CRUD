...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Down Aspect</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.aut.islab.ghaemi.minuy.myUiDsl.impl.DownAspectImpl#getValue <em>Value</em>}</li>
 *   <li>{@link edu.aut.islab.ghaemi.minuy.myUiDsl.impl.DownAspectImpl#getMeasureType <em>Measure Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DownAspectImpl extends MinimalEObjectImpl.Container implements DownAspect
{
  /**
  ...
  {
    return MyUiDslPackage.Literals.DOWN_ASPECT;
  }
  ...
  public void setValue(int newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyUiDslPackage.DOWN_ASPECT__VALUE, oldValue, value));
  }
  ...
  public void setMeasureType(String newMeasureType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyUiDslPackage.DOWN_ASPECT__MEASURE_TYPE, oldMeasureType, measureType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyUiDslPackage.DOWN_ASPECT__VALUE:
        return getValue();
      case MyUiDslPackage.DOWN_ASPECT__MEASURE_TYPE:
