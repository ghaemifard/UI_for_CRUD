...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Mid Val</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.aut.islab.ghaemi.minuy.myUiDsl.impl.MidValImpl#getValue <em>Value</em>}</li>
 *   <li>{@link edu.aut.islab.ghaemi.minuy.myUiDsl.impl.MidValImpl#getMeasureType <em>Measure Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MidValImpl extends MinimalEObjectImpl.Container implements MidVal
{
  /**
  ...
  {
    return MyUiDslPackage.Literals.MID_VAL;
  }
  ...
  public void setValue(int newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyUiDslPackage.MID_VAL__VALUE, oldValue, value));
  }
  ...
  public void setMeasureType(String newMeasureType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyUiDslPackage.MID_VAL__MEASURE_TYPE, oldMeasureType, measureType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyUiDslPackage.MID_VAL__VALUE:
        return getValue();
      case MyUiDslPackage.MID_VAL__MEASURE_TYPE:
