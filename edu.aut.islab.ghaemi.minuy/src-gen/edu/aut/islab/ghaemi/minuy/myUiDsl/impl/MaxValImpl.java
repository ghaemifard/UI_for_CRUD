...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Max Val</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.aut.islab.ghaemi.minuy.myUiDsl.impl.MaxValImpl#getValue <em>Value</em>}</li>
 *   <li>{@link edu.aut.islab.ghaemi.minuy.myUiDsl.impl.MaxValImpl#getMeasureType <em>Measure Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MaxValImpl extends MinimalEObjectImpl.Container implements MaxVal
{
  /**
  ...
  {
    return MyUiDslPackage.Literals.MAX_VAL;
  }
  ...
  public void setValue(int newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyUiDslPackage.MAX_VAL__VALUE, oldValue, value));
  }
  ...
  public void setMeasureType(String newMeasureType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyUiDslPackage.MAX_VAL__MEASURE_TYPE, oldMeasureType, measureType));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyUiDslPackage.MAX_VAL__VALUE:
        return getValue();
      case MyUiDslPackage.MAX_VAL__MEASURE_TYPE:
